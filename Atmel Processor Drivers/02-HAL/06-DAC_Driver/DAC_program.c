...
void DAC_voidSetAnalogVolt(u16 Copy_u16AnalogmV)
	{
		...
		SetPinValue(DAC_U8_BIT0_PORT,DAC_U8_BIT0_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,1);
		SetPinValue(DAC_U8_BIT1_PORT,DAC_U8_BIT1_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,2);
		SetPinValue(DAC_U8_BIT2_PORT,DAC_U8_BIT2_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,3);
		SetPinValue(DAC_U8_BIT3_PORT,DAC_U8_BIT3_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,4);
		SetPinValue(DAC_U8_BIT4_PORT,DAC_U8_BIT4_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,5);
		SetPinValue(DAC_U8_BIT5_PORT,DAC_U8_BIT5_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,6);
		SetPinValue(DAC_U8_BIT6_PORT,DAC_U8_BIT6_PIN,Local_u8BitValue);
		Local_u8BitValue=GET_BIT(Local_u8DigitalValue,7);
		SetPinValue(DAC_U8_BIT7_PORT,DAC_U8_BIT7_PIN,Local_u8BitValue);		
	}
